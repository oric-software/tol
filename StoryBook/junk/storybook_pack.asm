...
/*
TODO : Crunch pictures !
*/



#define SIZE_BUFFER_PICTURE 2500
...
; Destination adress where we depackM
#define ptr_destination         tmp1

; Point on the end of the depacked stuffM
#define ptr_destination_end     tmp2

; Temporary used to hold a pointer on depacked stuffM
...
/*
.byt <datas_picture2
.byt <datas_pictures+$121b
.byt <datas_pictures+$1a5b
.byt <datas_pictures+$22fb
.byt <datas_pictures+$2a75
.byt <datas_pictures+$33a5
.byt <datas_pictures+$699D
.byt <datas_pictures+$3d05
.byt <datas_pictures+$4b65
.byt <datas_pictures+$5a85
.byt <datas_pictures+$699D
*/
PIC_CRUNCHED_HI
.byt >picture1
...
datas_pictures
#include "picture1.h"
#include "packinclude/picture1pack.h"
